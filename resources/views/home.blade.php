                                            ...
                                            <form method="GET" action="{{ route('login') }}">
                                                ...
                                                <div class="row justify-content-center text-center py-4">
                                                    <div class="form-group col-sm-6">
                                                        <button id="boton" name="boton" type="submit" class="btn-block w-100 p-1 rounded-2">{{ __('Login') }}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
    ...
    <div class="col-6  p-4 ">
        <div class="accordion accordion-flush px-3" id="accordionFlushExample">
            <div class="accordion-item row border-bottom border-top-0 border-3 border-success mb-5">
                ...
                <div class="col-2 pt-3 ps-3">
                    <button class="botonacordeon ver" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseOne">
                        <i class="fas fa-plus-square "></i>
                    </button>
                    {{-- <button class="botonacordeon cerrar" type="button" data-bs-toggle="collapse"
