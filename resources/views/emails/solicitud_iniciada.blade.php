...
<body style="text-align: center!important; font-family: 'Roboto', sans-serif;">
    ...
    <main>
        ...
        <table style="text-align: center; margin: 0 auto;">
            <tr>
                <td>
                    <h3 style="font-size: 2rem;">Confirmación de inicio de tu Solicitud</h3>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <p>
                        Tu solicitud de certificación de programas ha sido registrada con éxito bajo el número de
                        solicitud {{ $datosMail->idSolicitud }}.
                        Podés consultar el estado de la misma cuando lo desees a partir del botón de abajo.<br>Recibirás
                        una notificación via email cuando el trámite haya finalizado.
                    </p>
                    <p>Atentamente,</p>
                    <div class="column">
