...
@section('cuerpo')
    ...
    <main class="p-2" id="cuerpo">
        <div class="container shadow-lg my-5 bg-light rounded col-lg-8">
            ...
            <form name="formulario_nota" id="formulario_nota" action="{{ route('planEstudio.store') }}" method="POST"
                class="container py-3 pb-5 px-2 px-md-4" novalidate>
                @csrf
                <h2 class="text-center cell py-3 my-3 d-none d-sm-block">Seleccionar Plan de Estudios</h2>
                <h3 class="text-center cell py-3 my-3 d-block d-sm-none">Seleccionar Plan de Estudios</h3>
                @isset($url_ranquel)
                    <div class="col-12">
                    ...
                    <div class="col-12 alert alert-dark mb-5 overflow-hidden" role="alert">
                        <ul>
                            @foreach ($url_ranquel as $url)
                                ...
                                <li>
                                    <div class="col"><a href="{{ $url }}" target="_blank"
                ...
                <div class=" col-12 alert alert-secondary mb-5" role="alert">
                    ...
                    <ul>
                        ...
                        @isset($plan_anio_mod) <li>Año de Ordenanza Mod: <strong>{{ $plan_anio_mod }}</strong></li>
                        @endisset
                        @isset($plan_nro_mod) <li>Número de Ordenanza Mod: <strong>{{ $plan_nro_mod }}</strong></li>
                        @endisset
                    </ul>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="inputs_contenedor" class="">
                        <input type="text" name="urlRanquel[]" class="form-control" value="{{ end($url_ranquel) }}"
                            placeholder="Ingresa URL de archivo en Ranquel.">
                    </div>
                ...
                <div class="form-group mt-4 d-lg-flex">
                    ...
                    <div class="col-12 col-lg-3  p-1">
                        <input type="button" value="Limpiar" onclick="document.getElementById('url_ranquel').value = ''"
                            class="btn botonFormulario2">
                    </div>
                    <div class="col-12 col-lg-6  p-1">
                        <input type="submit" value="Plan de estudios y ordenanzas" class="btn botonFormulario">
                    </div>
                    <div class="col-12 col-lg-3  p-1">
                        <a href="{{ session('success') ? route('notaDA.crear', $solicitud->id_solicitud) : '#' }}"
                            class="btn {{ session('success') ? 'botonFormulario2' : 'botonFormulario2 disabled' }}">Continuar</a>
                    </div>
                </div>
