                                                                                                ...
                                                                                                <div class="row justify-content-center text-center py-4">
                                                                                                    <div class="form-group col-sm-6">
                                                                                                        <button id="boton" name="boton" type="submit"
                                                                                                            class="botonFormulario">Enviar Mensaje
                                                                                                        </button>
                                                                                                    </div>
                                                                                            </div>
                                                                                        </form>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-8 col-12">
                        <div class="card card-form bg-light">
                            ...
                            {{-- legajo --}}
                            <div class="row justify-content-between text-left ">
                                <p><span class="text-secondary">Legajo: </span> {{ $solicitud->legajo }}</p>
                            </div>
                            {{-- unidad academica --}}
                            <div class="row justify-content-between text-left">
                                <p><span class="text-secondary">Unidad Académica: </span>
                                    {{ $solicitud->carrera->unidad_academica->unidad_academica }}
                                </p>
                            </div>
                            {{-- carrera --}}
                            <div class="row justify-content-between text-left ">
                                <p><span class="text-secondary">Carrera: </span>
                                    {{ $solicitud->carrera->carrera }}
                                </p>
                            </div>
                            {{-- universidad de destino --}}
                            <div class="row justify-content-center text-left">
                                <p><span class="text-secondary">Institución Educativa de Destino: </span>
                                    {{ $solicitud->universidad_destino }}
                                </p>
                            </div>
                            {{-- Comienzo div Actividad (mostrar como acordeón) --}}
                                                                                    ...
                                                                                    <div class="card card-form">
                                                                                        <form class="" method="POST" action="{{ route('comentario.store') }}">
                                                                                            ...
                                                                                            <div class="row justify-content-between text-left">
                                                                                                ...
                                                                                                <div class="row justify-content-center text-center py-4">
                                                                                                    <div class="form-group col-sm-6">
                                                                                                        <button id="boton" name="boton" type="submit" class="botonFormulario">
                                                                                                            Enviar mensaje
                                                                                                        </button>
                                                                                                    </div>
                                                                                                </div>
                                        ...
                                        <div class="form-group mt-4 d-lg-flex">
                                            ...
                                            <div class="col-12 col-lg-4 p-1">
                                                <a type="button" href="{{ route('verHojaResumen', $solicitud->id_solicitud) }}"
                                                    class="btn botonFormulario">Descargar Preliminar
                                                </a>
                                            </div>
                                            {{-- un boton para cargar archivo(firma secretaria -imagen) --}}
                                            <div class="col-12 col-lg-4  p-1">
                                                <button id="boton" name="boton" class="botonFormulario2" data-bs-toggle="modal" data-bs-target="#login_check1">
                                                    Aplicar Firma
                                                </button>
                                                ...
                                                <form action="{{ route('firmaSecretaria') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" id="idSolicitud" name="idSolicitud" value="{{ $solicitud->id_solicitud }}">
                                                    <div class="modal fade" id="login_check1" tabindex="-1" aria-labelledby="login_check1" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="login_check_h">
                                                                        ¿Esta seguro que desea aprobar la solicitud?
                                                                    </h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="input_contrasenia">Contraseña</label>
                                            ...
                                            <div class="col-12 col-lg-4  p-1">
                                                <a type="button" href="{{ route('verHojaResumen', $solicitud->id_solicitud) }}" class="btn botonFormulario">
                                                    Descargar Preliminar Firmado
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion" id="acordeonComentarios">
                                        <div class="accordion-item mt-4">
                                            ...
                                            <div id="collapseOne"
                                                ...
                                                <div class="accordion-body  d-flex justify-content-center acordeonComentarios">
                                                    <div class="table-responsive col-12 mx-3">
                                                        <h4 class="text-center fw-bold cell">
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                @foreach ($solicitud->estados as $estado)
                                                                    <tr>
                                                                        <td class="p-2">{{ $estado->created_at }}
                                                                        </td>
                                                                        <td class="p-2">
                                                                            {{ $estado->usuario->nombre ?? '' }}
                                                                            {{ $estado->usuario->apellido ?? '' }}
                                                                        </td>
                                                                        <td class="p-2">
                                                                            {{ $estado->estado_descripcion->descripcion }}
                                                                        </td>
                                                        ...
                                                        <a href="#" class="btn botonFormulario2" data-bs-toggle="modal" data-bs-target="#modalMensaje">
                                                            Nuevo Mensaje
                                                        </a>
                                                        <!-- Modal -->
                                        ...
                                        <div class="form-group mt-4 d-lg-flex">
                                            ...
                                            <div class="col-12 col-lg-6 px-0 pe-lg-1 py-1">
                                                ...
                                                <a type="button"
                                                    ...
                                                    class="btn botonFormulario2">Ver hoja Resumen
                                                </a>
                                            </div>
                                            <div class="col-12 col-lg-6 px-0 pe-lg-1 py-1">
                                                <form action="{{ route('crearNotaAdminCentral') }}" method="POST" autocomplete="off">
                                                    @csrf
                                                    <input type="hidden" id="idSolicitud" name="idSolicitud" value="{{ $solicitud->id_solicitud }}">
                                                    <input type="submit" class="btn botonFormulario2" value="Generar nota administración">
                                                </form>
                                            </div>
                                        </div>
                                        <div class="form-group d-lg-flex">
                                            ...
                                            <div class="col-12 col-lg-4  px-0 pe-lg-1 py-1">
                                                <a href="{{ route('archivos.downloadSinFirma', $solicitud->id_solicitud) }}"
                                                    class="btn botonFormulario">Descargar doc. sin firmar
                                                </a>
                                            </div>
                                            ...
                                            @if ($solicitud->hojaResumen != null)
                                                @if ($solicitud->hojaResumen->hoja_resumen_final == null)
                                                    {{-- un boton para cargar archivo(firma secretaria -imagen) --}}
                                                    <div class="col-12 col-lg-4  px-0 pe-lg-1 py-1">
                                                        <a href="#" class="btn botonFormulario2 form-control disabled">
                                                            Adjuntar doc. Firmado
                                                        </a>
                                                    </div>
                                                    {{-- un botòn para decargar --}}
                                                    <div class="col-12 col-lg-4  px-0 pe-lg-1 py-1">
                                                        <a href="#" class="btn botonFormulario disabled">
                                                            Descargar doc. Firmado
                                                        </a>
                                                    </div>
                                                @else
                                                    <div class="col-12 col-lg-4  px-0 pe-lg-1 py-1">
                                                        <a href="{{ route('archivos.create', 'dato=' . $solicitud->id_solicitud) }}"
                                                            class="btn botonFormulario2 form-control">
                                                            Adjuntar doc. Firmado
                                                        </a>
                                                    </div>
                                                    <div class="col-12 col-lg-4  px-0 pe-lg-1 py-1">
                                                        <a href="{{ route('archivos.downloadFirmado', $solicitud->id_solicitud) }}"
                                                            class="btn botonFormulario">
                                                            Descargar doc. Firmado
                                                        </a>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="form-group mt-4 d-lg-flex">
                                            <div class="col-12 px-0">
                                                @if ($solicitud->hojaResumen != null)
                                                    ...
                                                    @else
                                                        <button id="boton" name="boton" class="botonFormulario"
                                                            data-bs-toggle="modal" data-bs-target="#login_check">
                                                            Aprobar y notificar
                                                        </button>
                                                    @endif
                                                @endif
                                                ...
                                                <form
                                                    ...
                                                    <div class="modal fade" id="login_check" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="login_check_h">¿Esta
                                                                        seguro que
